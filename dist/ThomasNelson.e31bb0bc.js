...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./about.js":"components/mainContent/about.js","./blog.js":"components/mainContent/blog.js","./home.js":"components/mainContent/home.js","./contact.js":"components/mainContent/contact.js"}],"node_modules/Navigo/lib/navigo.min.js":[function(require,module,exports) {
var define;
...
router.on(":page", function (params) {
  return render(state["".concat(params.page.slice(0, 1).toUpperCase()).concat(params.page.slice(1).toLowerCase())]).on("/", render()).resolve();
});
render(state); // document.querySelector('#navigation a')
...
},{"./components":"components/index.js","./components/mainContent":"components/mainContent/index.js","./store":"store/index.js","Navigo":"node_modules/Navigo/lib/navigo.min.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
